...
- ## Dataset (1.53GB)
- **Official**: Download from [Swedish National Data Service](https://api.researchdata.se/dataset/2024-34/3/file/zip) (SCANIA Component X: multivariate time-series for PdM).[web:30]
- **Mirror**: My Google Drive(https://drive.google.com/drive/folders/1Ji7N7gwyQPdgn2pF3kyNLuvJjFcRCSHr?usp=sharing)
- **Access**: `dvc pull` (tracks via DVC; auto-downloads to `/data/raw/`).
- **Details**: Train/val/test CSVs; sensors (170+), specs, TTE; DOI:10.5878/bnh5-ka77
